...
class FineTuneStylegan(nn.Module):
    ...
    def __init__(self, image_size, latent_dim=512, noise_dim=100, style_depth=8, network_capacity=16, transparent=False, steps=1, lr=2e-4):
        ...
        generator_params = list(self.G.downsample.parameters())
        ...
        ###############################################
        # E_params = list(self.E.to_logit.parameters())+list(self.G.downsample.parameters())
        ...
        E_param_groups = [{'params': self.E.to_logit.parameters(), 'lr': self.lr},
                          {'params': new_params, 'lr': self.lr/10}, #other E layers
                          {'params': self.N.parameters(), 'lr': self.lr/10},
                          ]
